  ...
  module Apis
    module DataflowV1b3
      ...
      class DataflowService < Google::Apis::Core::BaseService
        ...
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def list_project_location_job_messages(project_id, location, job_id, start_time: nil, page_token: nil, page_size: nil, minimum_importance: nil, end_time: nil, fields: nil, quota_user: nil, options: nil, &block)
        ...
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def get_project_template(project_id, view: nil, gcs_path: nil, location: nil, fields: nil, quota_user: nil, options: nil, &block)
        ...
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def list_project_job_messages(project_id, job_id, page_token: nil, start_time: nil, page_size: nil, minimum_importance: nil, end_time: nil, location: nil, fields: nil, quota_user: nil, options: nil, &block)
