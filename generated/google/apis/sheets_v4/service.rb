  ...
  module Apis
    module SheetsV4
      ...
      class SheetsService < Google::Apis::Core::BaseService
        ...
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def batch_get_spreadsheet_values(spreadsheet_id, date_time_render_option: nil, value_render_option: nil, major_dimension: nil, ranges: nil, fields: nil, quota_user: nil, options: nil, &block)
        ...
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def get_spreadsheet_values(spreadsheet_id, range, major_dimension: nil, date_time_render_option: nil, value_render_option: nil, fields: nil, quota_user: nil, options: nil, &block)
