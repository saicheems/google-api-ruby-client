  ...
  module Apis
    module SlidesV1
      ...
      class SlidesService < Google::Apis::Core::BaseService
        ...
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def get_presentation_page_thumbnail(presentation_id, page_object_id, thumbnail_properties_thumbnail_size: nil, thumbnail_properties_mime_type: nil, quota_user: nil, fields: nil, options: nil, &block)
