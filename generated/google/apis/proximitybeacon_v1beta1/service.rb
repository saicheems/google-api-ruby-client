  ...
  module Apis
    module ProximitybeaconV1beta1
      ...
      class ProximitybeaconService < Google::Apis::Core::BaseService
        ...
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def list_beacons(page_size: nil, q: nil, project_id: nil, page_token: nil, fields: nil, quota_user: nil, options: nil, &block)
        ...
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def list_beacon_diagnostics(beacon_name, page_token: nil, alert_filter: nil, page_size: nil, project_id: nil, fields: nil, quota_user: nil, options: nil, &block)
