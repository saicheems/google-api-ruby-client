  ...
  module Apis
    module YoutubereportingV1
      ...
      class YouTubeReportingService < Google::Apis::Core::BaseService
        ...
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def list_jobs(include_system_managed: nil, page_token: nil, page_size: nil, on_behalf_of_content_owner: nil, fields: nil, quota_user: nil, options: nil, &block)
        ...
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def list_report_types(on_behalf_of_content_owner: nil, include_system_managed: nil, page_token: nil, page_size: nil, fields: nil, quota_user: nil, options: nil, &block)
