  ...
  module Apis
    module ClouddebuggerV2
      ...
      class CloudDebuggerService < Google::Apis::Core::BaseService
        ...
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def list_debugger_debuggee_breakpoints(debuggee_id, wait_token: nil, client_version: nil, action_value: nil, include_all_users: nil, include_inactive: nil, strip_results: nil, fields: nil, quota_user: nil, options: nil, &block)
