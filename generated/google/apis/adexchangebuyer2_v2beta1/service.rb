  ...
  module Apis
    module Adexchangebuyer2V2beta1
      ...
      class AdExchangeBuyerIIService < Google::Apis::Core::BaseService
        ...
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def list_account_filter_sets(account_id, page_token: nil, page_size: nil, fields: nil, quota_user: nil, options: nil, &block)
        ...
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def list_account_filter_set_impression_metrics(account_id, filter_set_id, page_token: nil, page_size: nil, fields: nil, quota_user: nil, options: nil, &block)
        ...
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def list_account_filter_set_bid_metrics(account_id, filter_set_id, page_token: nil, page_size: nil, fields: nil, quota_user: nil, options: nil, &block)
        ...
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def list_account_filter_set_bid_response_errors(account_id, filter_set_id, page_token: nil, page_size: nil, fields: nil, quota_user: nil, options: nil, &block)
        ...
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def list_account_filter_set_bid_responses_without_bids(account_id, filter_set_id, page_token: nil, page_size: nil, fields: nil, quota_user: nil, options: nil, &block)
        ...
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def list_account_filter_set_filtered_bids(account_id, filter_set_id, page_token: nil, page_size: nil, fields: nil, quota_user: nil, options: nil, &block)
        ...
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def list_account_filter_set_filtered_bid_details(account_id, filter_set_id, creative_status_id, page_token: nil, page_size: nil, fields: nil, quota_user: nil, options: nil, &block)
        ...
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def list_account_filter_set_non_billable_winning_bids(account_id, filter_set_id, page_token: nil, page_size: nil, fields: nil, quota_user: nil, options: nil, &block)
